...
export function ChatAssistant() {
  ...
  const getDynamicMessage = () => {
    ...
    else if (path.includes('all-on-four')) treatment = t('treatments.allOn4', 'All-on-4 Restoration')
    ...
    else if (path.includes('smile-makeover')) treatment = t('treatments.smileMakeover', 'Smile Makeover')
  ...
  return (
    <>
      ...
      <div 
        ref={containerRef} 
        className={`fixed bottom-6 ${isRTL ? 'right-6 sm:right-8' : 'left-6 sm:left-8'} z-50 flex flex-col ${isRTL ? 'items-end' : 'items-start'}`}
      >
      <AnimatePresence>
        {isOpen && (
          <motion.div
          ...
          >
            ...
            <div className="p-4 pb-2 relative shrink-0">
              <button 
                onClick={() => setIsOpen(false)}
                className={`absolute top-4 ${isRTL ? 'left-4' : 'right-4'} text-gray-400 hover:text-[#1b4698] transition-all active:scale-90`}
                aria-label={t('a11y.closeAssistant', 'Close Assistant')}
              >
                <X className="h-5 w-5" />
              </button>
              
              <div className="flex items-center gap-3">
                <div className="relative h-10 w-10 rounded-full bg-white p-1.5 shadow-sm border border-gray-100 shrink-0">
                  <img src="/logofera.png" alt={t('alt.feraClinic', 'FeRa Clinic')} className="h-full w-full object-contain" />
                ...
                <div>
                  <h3 className="text-base font-bold text-[#1b4698] tracking-tight leading-tight">
                    {t('chat.welcomeTitle')}
                  </h3>
            ...
            <div className="overflow-y-auto max-h-[60vh] flex-1 custom-scrollbar">
              ...
              <div className="px-4 pt-0 relative z-10">
                <div className="rounded-xl bg-[#1b4698]/5 p-3.5 border border-[#1b4698]/10 text-[13px] leading-relaxed text-[#1b4698] font-medium shadow-sm">
                  {t('chat.welcomeMsg')}
                </div>
              </div>
              ...
              <AnimatePresence mode="wait">
                {isSubmitted ? (
                  ...
                  >
                    ...
                    <h4 className="mb-3 text-xl font-bold text-[#1b4698] leading-tight px-4">
                      {t('chat.formSuccess')}
                    </h4>
                    <motion.a
                  ...
                  >
                    <button
                      ...
                      className="mb-4 flex items-center gap-2 text-[10px] font-bold text-[#6B7280] uppercase tracking-wider hover:text-[#1b4698] transition-colors"
                    >
                      <ChevronLeft className="h-3 w-3" />
                      {selectedFaq ? t('chat.faqTitle') : t('chat.formBack')}
                    </button>

                    <h4 className="text-xl font-bold text-[#1b4698] mb-6">
                      {t('chat.faqTitle')}
                    </h4>
                      ...
                      <div className="space-y-6">
                        <div className="flex flex-col gap-4">
                          <motion.div 
                            ...
                            className="self-end bg-[#1b4698] text-white p-4 rounded-2xl rounded-tr-none text-sm font-medium max-w-[85%] shadow-md"
                          >
                          ...
                          <motion.div 
                            ...
                            className="self-start bg-gray-50 text-[#1b4698] p-4 rounded-2xl rounded-tl-none text-sm font-medium max-w-[85%] border border-gray-100 shadow-sm leading-relaxed"
                          >
                        ...
                        <div className="pt-4 space-y-3">
                          <motion.button 
                            ...
                            className="w-full h-11 flex items-center justify-between px-3 rounded-xl bg-white border border-gray-100 hover:shadow-md hover:bg-[#1b4698]/5 transition-all duration-300 group"
                          >
                            <div className="flex items-center gap-2.5">
                              <div className="bg-[#1b4698]/5 rounded-lg p-1.5 group-hover:bg-[#1b4698]/10 transition-colors">
                                <Calendar className="h-3.5 w-3.5 text-[#1b4698]" />
                              </div>
                              <span className="text-sm font-medium text-[#1b4698]">{t('chat.actionConsultation')}</span>
                            </div>
                            <ArrowRight className="h-3 w-3 text-gray-400 group-hover:text-[#1b4698] group-hover:translate-x-1 transition-all" />
                          </motion.button>
                          <motion.div whileHover={{ scale: 1.02, x: 4 }} whileTap={{ scale: 0.98 }}>
                            ...
                            >
                              <div className="flex items-center gap-2.5">
                                <div className="bg-[#1b4698]/5 rounded-lg p-1.5 group-hover:bg-[#1b4698]/10 transition-colors">
                                  <Star className="h-3.5 w-3.5 text-[#1b4698]" />
                                </div>
                                <span className="text-sm font-medium text-[#1b4698]">{t('chat.actionTreatments')}</span>
                              </div>
                              <ArrowRight className="h-3 w-3 text-gray-400 group-hover:text-[#1b4698] group-hover:translate-x-1 transition-all" />
                            </Link>
                          </motion.div>
                      ...
                      <div className="space-y-3">
                        {faqs.map(faq => (
                          <motion.button
                            ...
                            className="w-full h-11 text-start px-3 rounded-xl bg-white border border-gray-100 hover:shadow-md hover:bg-[#1b4698]/5 transition-all duration-300 group"
                          >
                            <div className="flex items-center justify-between">
                              <span className="text-[13px] font-medium text-[#1b4698] pe-4 truncate">
                                {faq.question}
                              </span>
                              <ArrowRight className="h-3 w-3 text-gray-400 group-hover:text-[#1b4698] group-hover:translate-x-1 transition-all flex-shrink-0" />
                            </div>
                          </motion.button>
                        ))}
                      </div>
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full rounded-xl bg-gray-50 border-none px-5 py-3.5 text-sm font-medium text-[#1b4698] focus:ring-2 focus:ring-[#1b4698]/10 transition-all placeholder:text-gray-300"
                        />
                      </div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="relative">
                          ...
                          <select
                            ...
                            className="w-full rounded-xl bg-gray-50 border-none px-5 py-3.5 text-sm font-medium text-[#1b4698] focus:ring-2 focus:ring-[#1b4698]/10 transition-all appearance-none cursor-pointer"
                          >
                        ...
                        <div className="relative">
                          ...
                          <select
                            ...
                            className="w-full rounded-xl bg-gray-50 border-none px-4 py-3 text-sm font-medium text-[#1b4698] focus:ring-2 focus:ring-[#1b4698]/10 transition-all appearance-none cursor-pointer"
                          >
                            {languages.map(l => (
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      type="submit"
                      className="w-full mt-3 h-12 flex items-center justify-between group px-5 rounded-xl bg-[#1b4698] hover:bg-[#006693] transition-all duration-300 shadow-lg shadow-blue-900/10"
                    >
                    ...
                    {getActions().map((action, idx) => {
                      ...
                      const content = (
                        <motion.div 
                          whileHover={{ scale: 1.02, x: 4 }}
                          whileTap={{ scale: 0.98 }}
                          className="flex h-11 items-center justify-between group px-3 rounded-xl bg-white border border-gray-100 hover:shadow-md hover:bg-[#1b4698]/5 transition-all duration-300 cursor-pointer"
                        >
                          <div className="flex items-center gap-2.5">
                            <div className="bg-[#1b4698]/5 rounded-lg p-1.5 group-hover:bg-[#1b4698]/10 transition-colors">
                              <action.icon className="h-3.5 w-3.5 text-[#1b4698] transition-colors" />
                            </div>
                            <span className="text-sm font-medium text-[#1b4698] transition-colors">
                              {action.label}
                            </span>
                          </div>
                          <ArrowRight className="h-3 w-3 text-gray-400 group-hover:text-[#1b4698] group-hover:translate-x-1 transition-all" />
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="group relative flex h-16 w-16 items-center justify-center rounded-full shadow-luxury-xl transition-all duration-300 bg-[#1b4698] text-white border-0"
        aria-label={t('a11y.toggleAssistant', 'Toggle Assistant')}
      >

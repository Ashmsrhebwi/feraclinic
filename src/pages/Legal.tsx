  ...
  return (
    <div className="min-h-screen bg-white py-32 px-6">
      <div className="w-full max-w-[94vw] sm:max-w-[680px] lg:max-w-[860px] 2xl:max-w-[1080px] bg-white/55 backdrop-blur-md rounded-3xl p-5 sm:p-6 md:p-8 lg:p-10 shadow-[0_10px_40px_rgba(0,0,0,0.06)]">
        <Link to="/" className="inline-flex items-center gap-2 text-[#006693] hover:text-[#1b4698] transition-colors mb-12 group">
        ...
        >
          <div className="flex items-center gap-4 mb-8">
            <div className="w-12 h-12 rounded-2xl bg-[#006693]/10 flex items-center justify-center text-[#006693]">
              {isPrivacy ? <Shield className="w-6 h-6" /> : <FileText className="w-6 h-6" />}
            </div>
            <h1 className="text-4xl lg:text-5xl font-bold text-[#1b4698] tracking-tight">{title}</h1>
          </div>

          <div className="prose prose-slate prose-lg max-w-none text-gray-500 font-light leading-relaxed space-y-8">
            <section>
              <h2 className="text-xl font-bold text-[#1b4698] uppercase tracking-widest text-sm mb-4">

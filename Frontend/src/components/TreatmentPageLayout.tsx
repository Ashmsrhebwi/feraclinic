...
import { ArrowRight, CheckCircle2, ChevronDown, Phone, ShieldCheck, Clock, Sparkles, UserCheck, Activity, HeartPulse, Microscope, Target, Zap } from 'lucide-react'
  ...
  return (
    <div className="bg-white min-h-screen">
        ...
        <div className="container-std relative z-10 pt-20">
          <div className="max-w-4xl">
            <motion.div
              ...
              className="bg-white/10 backdrop-blur-2xl rounded-[2rem] sm:rounded-[3rem] p-6 sm:p-8 lg:p-16 shadow-2xl border border-white/20"
            >
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-[72px] font-serif font-bold text-white tracking-tight leading-[1.05] mb-6 sm:mb-8 drop-shadow-[0_2px_10px_rgba(0,0,0,0.45)]">
                {title}
              </h1>

              <p className="text-lg sm:text-xl text-white/85 font-light leading-relaxed max-w-xl sm:max-w-2xl mb-8 sm:mb-12 drop-shadow-sm">
                {heroDescription}
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                <Link to="/consultation" className="w-full sm:w-auto">
                  <motion.button 
                    className="w-full sm:min-w-[220px] h-16 sm:h-20 bg-white text-[#0B1C2D] rounded-full font-bold text-xs uppercase tracking-[0.3em] shadow-2xl transition-all duration-500"
                ...
                <a href={`https://wa.me/${t('common.whatsappNumber', '905367460100')}`} target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                  <motion.button 
                    className="w-full sm:min-w-[220px] h-16 sm:h-20 bg-transparent text-white border border-white/20 rounded-full font-bold text-xs uppercase tracking-[0.3em] transition-all duration-500"
      ...
      <section className="relative z-20 -mt-16 sm:-mt-20 container-std">
        <div className="bg-white rounded-[2rem] sm:rounded-[3rem] shadow-[0_30px_100px_rgba(11,28,45,0.12)] border border-gray-100/50 p-6 sm:p-8 sm:p-12">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-10 lg:gap-10">
            {[
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-start">
            ...
            >
              <div className="space-y-6">
                ...
                <h2 className="text-3xl sm:text-4xl lg:text-[56px] font-serif font-bold text-[#0B1C2D] tracking-tight leading-[1.1]">
              ...
              return (
                ...
                >
                  <div className="h-full bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-10 hover:bg-white/10 transition-all duration-500 flex flex-col">
                    ...
                    <h4 className="text-2xl font-bold text-white mb-6 tracking-tight">{stepTitle}</h4>
          ...
          <div className="flex flex-col lg:flex-row gap-24 items-center">
            ...
            >
              <div className="space-y-6">
                ...
                <h2 className="text-3xl sm:text-4xl lg:text-[64px] font-serif font-bold text-[#0B1C2D] tracking-tight leading-[1.05]">
      ...
      <section className="py-24 lg:py-32 px-6 bg-white">
        <div className="container-std">
          <div className="bg-gradient-to-r from-[#0B1C2D] to-[#123A6B] rounded-[2rem] sm:rounded-[3rem] lg:rounded-[4rem] px-6 sm:px-12 lg:px-24 py-16 sm:py-24 lg:py-32 text-center relative overflow-hidden shadow-[0_40px_120px_rgba(11,28,45,0.25)] group">
            ...
            <div className="relative z-10 space-y-12">
              <div className="flex flex-col items-center gap-6">
                ...
                <h2 className="text-3xl sm:text-4xl lg:text-[72px] font-serif font-bold text-white tracking-tight leading-[1.05] max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8">
                <Link to="/consultation" className="w-full sm:w-auto">
                  <motion.button 
                    className="w-full sm:w-auto px-8 sm:px-12 h-16 sm:h-20 bg-white text-[#0B1C2D] rounded-full font-bold text-base sm:text-lg uppercase tracking-widest shadow-2xl transition-all duration-500"
                    whileHover={{ y: -4, boxShadow: "0 20px 40px rgba(255,255,255,0.2)" }}
                    whileTap={{ scale: 0.98 }}
                  >
                ...
                <a href={`https://wa.me/${t('common.whatsappNumber', '905367460100')}`} target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                  <motion.button 
                    className="w-full sm:w-auto px-8 sm:px-12 h-16 sm:h-20 bg-transparent text-white border border-white/20 rounded-full font-bold text-base sm:text-lg uppercase tracking-widest transition-all duration-500 flex items-center justify-center gap-4 group/wa"
                    whileHover={{ y: -4, backgroundColor: "rgba(255,255,255,0.1)" }}
                    whileTap={{ scale: 0.98 }}
                  >
